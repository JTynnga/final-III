    ...
    <body>
        <div class="bg-[#f1f3f5] h-screen w-screen flex">
            <section id="toggleMenu" class="h-full w-1/6 bg-[#30363b]">
                <a id="toggleMenuU" class="h-16 w-full border-b flex md:justify-start justify-center md:pl-4 items-center" href="./menu0.php">
                ...
                <div class="w-full flex flex-col justify-center items-center text-white">
                    ...
                    <button id="btnUsers" class="<?php print_r($_SESSION['pemision2']);
                                                    print_r($_SESSION['pemision3']); ?> w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                        <svg xmlns="http://www.w3.org/2000/svg" height="48" fill="currentcolor" viewBox="0 -960 960 960" width="48">
                        ...
                        <p id="pUsers" class="md:flex hidden pl-2">Usuarios</p>
                    </button>
            ...
            <div id="section01" class="flex flex-col h-full w-5/6 justify-between items-center">
                <section class=" flex flex-col w-full h-[90%] justify-start items-center">
                    <nav class="h-16 w-full bg-white flex md:justify-between justify-end items-center border">
                        <div class="hidden md:flex h-full justify-start items-center">
                            ...
                            <p class="pl-4">Menu Principal</p>
                        </div>
                        <div id="open" class="flex h-full md:w-48 w-40 justify-end items-center px-4 hover:bg-[#f2f2f2]">
                            <p class="pr-2 truncate">
                                <?php print_r($_SESSION["nombre"] . " " . $_SESSION["apellido"]); ?>
                            </p>
                    ...
                    <div class="h-16 w-11/12  flex justify-between items-center">
                        ...
                        <p class="text-xs md:text-base"><a href="./menu0.php" class=" text-sky-500">Home</a> / <span id="title02">Dashboard</span></p>
                    </div>
                    ...
                    <section id="sectionUsers" class="hidden flex border md:h-[77%] h-[70%] w-11/12  justify-start items-start">
                        <?php include("./verUsers.php"); ?>
                    </section>
                ...
                <footer class="h-12 w-full md:text-base text-xs bg-white flex justify-between items-center border px-4 text-gray-500">
                    <p>Copyright © 2023 <a class="text-gray-700" href="https://github.com/joseynga" target="_blank">Funval2023.</a>
