...
<body>
    <div class="bg-[#f1f3f5] h-screen w-screen flex">
        <section id="toggleMenu" class="h-full w-1/6 bg-[#30363b]">
            <a id="toggleMenuU" class="h-16 w-full border-b flex md:justify-start justify-center md:pl-4 items-center"
                href="./menu0.php">
            ...
            <div class="w-full flex flex-col justify-center items-center text-white">
                ...
                <button id="btnAlumnos002"
                    class="<?php print_r($_SESSION['pemision3']);
        ...
        <div id="section01" class="flex flex-col h-full w-5/6 justify-between items-center">
            <section class=" flex flex-col w-full h-[90%] justify-start items-center">
                    ...
                    <ul id="toggle"
                        ...
                        <div class=" w-11/12 border-b border-gray">
                            <button id="btnProfile"
                                class="hover:bg-gray-200 w-full flex justify-start items-center rounded-2xl px-4">
                ...
                <div class="h-16 w-11/12  flex justify-between items-center">
                    ...
                    <p class="text-xs md:text-base"><a href="./menu0.php" class=" text-sky-500">Home</a> / <span
                ...
                <section id="sectionBienvenida" class="flex w-11/12  justify-start items-start">
                    <card class=" w-[540px] p-4 bg-white border">
                        <p>Bienvenido</p>
                        <p>Seleciona una opcion para empezar</p>
                    </card>
                </section>
                ...
                <section id="sectionMaestros"
                    class="hidden flex border md:h-[77%] h-[70%] w-11/12  justify-start items-start">
                    <?php include("./verMaestros.php"); ?>
                </section>
                <section id="sectionAlumnos"
                    class="hidden flex border md:h-[77%] h-[70%] w-11/12  justify-start items-start">
                    <?php include("./verAlumnos.php"); ?>
                </section>
                <section id="sectionClases"
                    class="hidden flex border md:h-[77%] h-[70%] w-11/12  justify-start items-start">
                    <?php include("./verClasses.php"); ?>
                </section>
                ...
                <section id="sectionAlumnosDelProfe"
                    class="hidden flex md:h-[77%] h-[70%] w-11/12 justify-start items-start">
                    <?php include("./alumnosxProfe.php"); ?>
                </section>
            </section>
            <footer
                class="h-12 w-full md:text-base text-xs bg-white flex justify-between items-center border px-4 text-gray-500">
                <p>Copyright © 2023 <a class="text-gray-700" href="https://github.com/joseynga"
                        target="_blank">Funval2023.</a>
