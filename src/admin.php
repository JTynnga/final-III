...
<body>
    <div class="bg-[#f1f3f5] h-screen w-screen flex">
        <section id="toggleMenu" class="h-full w-1/5 bg-[#30363b]">
            <div id="toggleMenuU"
                class="h-16 w-full border-b flex md:justify-start justify-center md:pl-4 items-center">
                <div class=" h-12 rounded-full overflow-hidden">
                    <img class="h-12" src="../assets/logoQ.jpg" alt="LogoUni.jpg" />
                </div>
                <p id="Uni" class="md:flex hidden text-white pl-3 text-2xl">Universidad</p>
            </div>
            <div id="CARGO"
                class="md:flex hidden h-28 w-full border-b flex-col justify-around items-start text-white p-4">
                <p><?php print_r($_SESSION["nombre"]); ?></p>
                <p><?php print_r($_SESSION["cargo"]); ?></p>
            </div>
            <div class="w-full flex flex-col justify-center items-center text-white">
                ...
                <button id="btnPermisos"
                    class="<?php print_r($_SESSION['pemision2']);
                ...
                <button id="btnAlumnos"
                    class="<?php print_r($_SESSION['pemision3']); ?> w-full flex md:justify-start justify-center items-center p-4 hover:bg-[#3d4449]">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                        <path
                ...
                <button id="btnCalificaciones"
                    class="<?php print_r($_SESSION["pemision1"]);
                ...
                <button id="btnAdminis"
                    ...
                    <p id="pdminis" class="md:flex hidden pl-2">Administra tus Clases</p>
                </button>
            </div>
        </section>

        <section id="section01" class="flex flex-col w-4/5 h-full justify-start items-center">
            <nav class="h-16 w-full bg-white flex md:justify-between justify-end items-center border">
                ...
                <div id="open" class="flex h-full  justify-end items-center px-4 hover:bg-[#f2f2f2]">
                    <p class="pr-2"><?php print_r($_SESSION["cargo"]); ?></p>
                    <svg id="spin" style="transition-duration: 500ms;" xmlns="http://www.w3.org/2000/svg" fill="none"
                ...
                <ul id="toggle"
                    ...
                    <div class=" w-11/12 border-b border-gray">
                        <a href="personalInfo.php"
                            class="hover:bg-gray-200 flex justify-start items-center rounded-2xl px-4">
            ...
            <div class="h-16 w-11/12  flex justify-between items-center">
                <p id="title01" class="text-xl md:text-2xl font-medium">Dashboard</p>
                <p class="text-xs md:text-base"><span class=" text-sky-500">Home</span> / <span
                        id="title02">Dashboard</span></p>
            </div>
