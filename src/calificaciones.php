<card class=" w-full md:h-full h-[350px] bg-white border md:overflow-y-scroll md:overflow-x-hidden overflow-scroll">
    ...
    <div class="relative md:p-4 p-2 pt-0">
        <button
            class=" top-5 w-fit dark:bg-gray-500 dark:hover:bg-gray-700 bg-[#007aff] hover:bg-[#1d3e8f] text-white  md:py-2 md:px-4 p-2 rounded-lg absolute  md:text-base text-xs"
            type=''>Inscribirse</button>
