    ...
    <div class="relative md:p-4 p-2 pt-0">
        <table id="tablaAlumnos4Profe" class="display  border md:text-base text-xs">
            ...
            <tbody>
                ...
                <!-- Modal toggle -->
                <form class="h-fit" method="post" action="./agregarCali.php">
                    <!-- <input class="hidden" name="iValue" value="$i" /> -->
                    <button data-modal-target="<?php print_r($l . "Modaless"); ?>"
                        data-modal-toggle="<?php print_r($l . "Modaless"); ?>" type="button"
                        class=" rounded-sm shadow hover:shadow-md hover:bg-blue-100">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="#007bfe" class="w-6 h-6">
                    ...
                    <!-- Main modal -->
                    <div id="<?php print_r($l . "Modaless"); ?>" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div
                                    ...
                                    <button type="button"
                                        ...
                                        data-modal-hide="<?php print_r($l . "Modaless"); ?>">
                                ...
                                <div class="p-6 space-y-6 flex flex-col">
                                    <input class="rounded-lg hidden" type="text" name="idnombreCali"
                                        value="<?php print_r($id_info_fk4P); ?>" />
                                    <input class="rounded-lg hidden" type="text" name="idnombreClassCali"
                                        value="<?php print_r($idTeacherClass); ?>" />
                                    <b class="text-base  text-black">
                                        Ingrese la Calificacion del 0 a 100
                                    </b>
                                    <input class="rounded-lg" type="number" min="0" max="100" name="editCalificacion"
                                        value="<?php print_r($grade4P); ?>" required />

                                    <!-- Modal footer -->

                                    <div
                                        class="  flex w-full items-center justify-end pt-4 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                        <button data-modal-hide="<?php print_r($l . "Modaless"); ?>" type="button"
                                            class="text-white bg-gray-700 hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-blue-300
                ...
                <form class="h-fit" method="post" action="./agregarMsg.php">
                    <!-- <input class="hidden" name="iValue" value="$i" /> -->
                    <button data-modal-target="<?php print_r($l . "Modalessx"); ?>"
                        data-modal-toggle="<?php print_r($l . "Modalessx"); ?>" type="button"
                        class=" rounded-sm shadow hover:shadow-md hover:bg-blue-200">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="#007bff" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <!-- Main modal -->
                    <div id="<?php print_r($l . "Modalessx"); ?>" tabindex="-1" aria-hidden="true"
                        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-full max-w-xl max-h-full">
                            <!-- Modal content -->
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                ...
                                <div
                                    ...
                                    <button type="button"
                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                        data-modal-hide="<?php print_r($l . "Modalessx"); ?>">
                                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 14 14">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                ...
                                <!-- Modal body -->
                                <div class="p-6 space-y-6 flex flex-col">
                                    <input class="rounded-lg hidden" type="text" name="idnombreMensa"
                                        value="<?php print_r($id_info_fk4P); ?>" />
                                    <input class="rounded-lg hidden" type="text" name="idnombreClassMensa"
                                        value="<?php print_r($idTeacherClass); ?>" />
                                    <b class="text-base  text-black">
                                        Ingrese un mesaje:
                                    </b>
                                    <input class="rounded-lg" type="text" name="editMensaje"
                                        value="<?php print_r($messages4P); ?>" required />

                                    <!-- Modal footer -->

                                    <div
                                        class="  flex w-full items-center justify-end pt-4 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                                        <button data-modal-hide="<?php print_r($l . "Modalessx"); ?>" type="button"
                                            class="text-white bg-gray-700 hover:bg-gray-400 focus:ring-4 focus:outline-none focus:ring-blue-300
                                        rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5
                                        hover:text-white focus:z-10 dark:bg-gray-700 dark:text-gray-300
                                        dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600
