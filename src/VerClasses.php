<card class=" w-full md:h-full h-[350px] bg-white border md:overflow-y-scroll md:overflow-x-hidden overflow-scroll">
    <div class="w-full h-fit border-b md:p-3 p-2 flex items-center justify-between">
        ...
        <form class="h-fit" method="post" action="./newClasse.php">
            ...
            <div id="defaultModalClasse" tabindex="-1" aria-hidden="true"
                    ...
                    <div class=" bg-white rounded-md shadow flex flex-col">
                        <div class="flex items-start justify-between p-4 border-b rounded-t ">
                            ...
                            <button type="button"
                                ...
                                data-modal-hide="defaultModalClasse">
                        ...
                        <div class="p-6 space-y-6 flex flex-col">
                            ...
                            <input class="rounded-lg" type="text" name="newClaseNombre"
                                placeholder="Ingresar el nombre de la materia" required />
                            <b class="text-base  text-black">
    ...
    <div class="relative md:p-4 p-2 pt-0">
        <table id="tablaClasses" class="display  border md:text-base text-xs">
            ...
            <tbody>
                ...
                <form class="h-fit" method="post" action="./editClasses.php">
                    <button data-modal-target="<?php print_r($k . "Modales"); ?>"
                        data-modal-toggle="<?php print_r($k . "Modales"); ?>" type="button"
                    ...
                    <div id="<?php print_r($k . "Modales"); ?>" tabindex="-1" aria-hidden="true"
                        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                        <div class="relative w-full max-w-2xl max-h-full">
                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                <div
                                    ...
                                    <button type="button"
                                        class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ml-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                        data-modal-hide="<?php print_r($k . "Modales"); ?>">
                                ...
                                <div class="p-6 space-y-6 flex flex-col">
                                    <input class="rounded-lg hidden" type="text" name="idDelInfo4Classe"
                                        value="<?php print_r($id4Info); ?>" />
                                    <input class="rounded-lg hidden" type="text" name="idDelClasse"
                                        value="<?php print_r($idClasse); ?>" />
                                    <b class="text-base  text-black">
                                        Nombre de la materia
                                    </b>
                                    <input class="rounded-lg" type="text" name="editClaseNombre"
                                        placeholder="Ingresar el nombre de la materia"
                                        value="<?php print_r($nameClasse); ?>" required />
                                    <b class="text-base  text-black">
                                        Maestros disponibles para la clase
                                    </b>
                ...
                <form class="h-fit" method="post" action="./deleteClasse.php">
                    <input class="rounded-lg hidden" type="text" name="idDelClasseDelete"
                        value="<?php print_r($idClasse); ?>" />
