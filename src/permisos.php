        ...
        <table id="tablaPermisos" class="display  border md:text-base text-xs">
            ...
            <tbody>
               ...
               $resultInfoAll = $mysqli->query("SELECT * FROM info");
                ...
                <form class="h-fit" method="post" action="./editPermisos.php">
                    <button data-modal-target="<?php print_r($emailAll); ?>"
                        data-modal-toggle="<?php print_r($emailAll); ?>" type="button"
                    ...
                    <div id="<?php print_r($emailAll); ?>" tabindex="-1" aria-hidden="true"
                            ...
                            <div class=" bg-white rounded-md shadow flex flex-col">
                                <div class="flex items-start justify-between p-4 border-b rounded-t ">
                                    ...
                                    <button type="button"
                                        ...
                                        data-modal-hide="<?php print_r($emailAll); ?>">
                                ...
                                <div class="p-6 space-y-6 flex flex-col">
                                    ...
                                    <input class="hidden rounded-lg" type="text" name="inputIdS"
                                        value="<?php print_r($id_infoAll); ?>" />
                                    <input class=" rounded-lg" type="email" name="inputEmailS"
                                        value="<?php print_r($emailAll); ?>" required />
                                    <b class="text-base  text-black">
                                        Rol de Usuario
                                    </b>
                                    ...
                                    <div>
                                        <label class="relative inline-flex items-center mb-4 cursor-pointer">
                                            <input name="permisoCheckbox" type="checkbox" value="1" class="sr-only peer"
                                                <?php
                                                                                                                                if ($estadoAll == 1) {
                                                                                                                                    print_r("checked");
                                                                                                                                } ?>>
                                            <div
                                                class="w-11 h-6 bg-gray-200 rounded-full peer peer-focus:ring-4 peer-focus:ring-green-300 dark:peer-focus:ring-blue-800 dark:bg-gray-700 peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-green-600">
                                            </div>
                        ...
                        <!-- Modal footer -->
                        <div class="  flex w-full items-end p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button data-modal-hide="' . $emailAll . '" type="button" class="text-gray-500
