<card
    class="md:w-[59%] w-full  md:h-full h-[174px] bg-white border md:overflow-y-scroll md:overflow-x-hidden overflow-scroll">
                    ...
                    echo "
                        <tr class='border'>
                                ...
                                <td class='text-center'>
                                    <form class=' h-fit' method='post' action='./inhabilita.php'>
...
<card
    class="md:w-[39%] w-full  md:h-full h-[174px] bg-white border md:overflow-y-scroll md:overflow-x-hidden overflow-scroll">
    <div class="w-full  border-b md:p-3 p-2">
    ...
    ?>
    <form class="flex flex-col w-full p-3 md:text-base text-xs" method='post' action='./inscribir.php'>
        <?php
            ...
            ?>
        <button
            class="md:mt-4 mt-2 w-fit dark:bg-gray-500 dark:hover:bg-gray-700 bg-[#007aff] hover:bg-[#1d3e8f] text-white  py-2 px-4 rounded-lg"
