...
<head>
    ...
    <link rel="preconnect" href="https://fonts.gogleapis.com">
...
<body class="bg-gray-500 h-screen w-screen  flex flex-col justify-center items-center">

    <div class="  flex flex-col justify-center items-center h-full md:h-[480px] w-screen  md:w-96 ">

        <form class="bg-[#fff5d2] flex flex-col justify-center md:justify-between h-full md:h-fit w-full md:w-96 p-10 md:p-10 border-0 md:border border-gray-400 md:rounded-3xl" name="formularioLogin" method="post" action="./src/menuLogin.php">
