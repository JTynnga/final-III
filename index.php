...
<body style="background: linear-gradient(90deg, rgba(39,70,154,1) 0%, rgba(17,144,205,1) 100%);"
    ...
    <div class="  flex flex-col justify-center items-center h-full md:h-[480px] w-screen  md:w-96 ">
        ...
        <form
            ...
            name="formularioLogin" method="post" action="./src/menuLogin.php">
            ...
            <div class="relative block mb-3">
                ...
                <input
                    class="block dark:bg-slate-600 bg-white w-full dark:text-white text-blue-800 font-semibold border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
                    type="email" name="emailLg" placeholder="Email" required />
            </div>
            ...
            <div class="relative block">
                ...
                <input
                    class="block dark:bg-slate-600 dark:text-white text-blue-800 font-semibold bg-white w-full border border-slate-300 rounded-md py-2 pl-9 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-sm"
            ...
            <button id="btnSubmit"
                class="w-full dark:bg-gray-500 dark:hover:bg-gray-700 bg-[#1d3e8f] hover:bg-[#7d8fab] text-white  py-2 px-4 rounded-lg"
                type="submit" name="start">Login</button>
        </form>
    </div>
